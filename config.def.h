...
static const char *fonts[]          = { "Terminus:style=Bold:pixelsize=12:antialias=true:autohint=true", "monospace:size=10" };
static const char dmenufont[]       = "Terminus:style=Bold:pixelsize=12:antialias=true:autohint=true";
